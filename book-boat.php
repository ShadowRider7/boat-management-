            ...
            <form action="#" class="row" method="post">
             ...
             <div class="form-group col-md-6">
              ...
              <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" name="phonenumber" maxlength="11" pattern="[0-9]+" required="true"> 
              </div>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-7 text-center">
            ...
            <p class="lead text-white">Have questions or need help? Contact us to make your boat booking seamless!</p>
