    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6">
        <h2>    <span class="text-serif text-primary">Welcome To Our Website</span></h2>
            <h5>  <p>Welcome to Our Website! We're excited to have you here. Our platform is designed to make boat booking simple, efficient, and enjoyable. Whether you're planning a trip or managing your reservations, we're here to provide you with a smooth and user-friendly experience. Dive in and explore all the ways we can enhance your boating journey!</p> </h5>
